...
class GenreFeatureData:
    ...
    dir_devfolder = "LSTM/Data/TRAIN"
    dir_testfolder = "LSTM/Data/TRAIN"
    dir_all_files = "LSTM/Data/TRAIN"
    ...
    dev_X_preprocessed_data = "LSTM/processed/data_validation_input.npy"
    dev_Y_preprocessed_data = "LSTM/processed/data_validation_target.npy"
